...
public class DatabaseService(string connectionString) : IDatabaseService
{
    ...
    [KernelFunction]
    [Description("Get all bookings after a specific date for a single hotel.")]
    ...
    [KernelFunction]
    [Description("Get all bookings which don't have any hotel room.")]
    ...
    [KernelFunction]
    [Description("Get all bookings which have multiple hotel rooms.")]
